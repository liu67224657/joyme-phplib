...
class Aliy_Request
{
	 ...
	 */
	public $request_class = 'Aliy_Request';

	/**
	 * The default class to use for HTTP Responses (defaults to <ResponseCore>).
	 */
	public $response_class = 'Aliy_Response';

	/**
	 * Default useragent string to use.
	 */
	public $useragent = 'AliyRequest/1.4.3';
	...
	public function streaming_read_callback($curl_handle, $file_handle, $length)
	{
		...
		if ($this->read_stream_read == 0 && isset($this->seek_position) && $this->seek_position !== ftell($this->read_stream))
		{
			...
			{
				throw new Exception('The stream does not support seeking and is either not at the requested position or the position is unknown.');
			}
		}
		...
		switch ($this->method)
		{
			case self::HTTP_PUT:
				...
				if (isset($this->read_stream))
				{
					...
					{
						throw new Exception('The stream size for the streaming upload cannot be determined.');
					}
